...
```{r}
#graph 2014
ggplot(data = pivot_2014_attempts, aes(x = type_of_degree, y = count, color= ifelse(college == "Green River", "Green River", "Other Colleges"))) + 
  geom_point() +
...
```{r}
#graph 2014
ggplot(data = pivot_2023_attempts, aes(x = type_of_degree, y = count, color= ifelse(college == "Green River", "Green River", "Other Colleges"))) + 
  geom_point() +
